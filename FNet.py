...
class FNet(nn.Module):
    ...
    def forward(self, prev_lr: torch.Tensor, curr_lr: torch.Tensor) -> torch.Tensor:
        ...
        _, _, c3a = self.encode_siamese(prev_lr, 'a')  # prev_lr features (H/8)
        ...
        # No encoder c2 skip here; just fuse deconv2 and upsampled flow
        concat2 = torch.cat([deconv2, up_flow3], dim=1)        # (B,66,H/4,W/4)
